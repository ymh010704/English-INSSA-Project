...
export default function LearningIntro() {
  ...
  const [active, setActive] = useState("today"); // 사이드바 활성 탭 설정
  ...
  if (loading) return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh", background: "#f0ede6" }}>
      <p style={{ fontWeight: 700, color: G.accent }}>학습 데이터를 준비 중입니다... 📥</p>
    </div>
  );
