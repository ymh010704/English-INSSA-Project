...
const OPENING_MESSAGES = {
  cafe:   `Hey! Start our café conversation naturally. 
           Greet me and say something about being at a café.`,
  party:  `Hey! Start our party conversation naturally. 
           Greet me like we just ran into each other at a party.`,
  sns:    `Start a casual Instagram DM conversation. 
           Send a short opening DM like a real Gen Z person would.`,
  friend: `Start a casual conversation between close friends. 
           Say hi and bring up something fun to talk about.`,
  work:   `Start a casual workplace conversation. 
           Greet me like a cool coworker at the office.`,
  date:   `Start a flirty, fun conversation like we have a crush on each other. 
           Keep it playful.`,
};
